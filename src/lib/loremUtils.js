...
export function generateParagraphs(count) {
  const result = [];
...
export function generateSentences(count) {
  const result = [];
  for (let i = 0; i < count; i++) {
